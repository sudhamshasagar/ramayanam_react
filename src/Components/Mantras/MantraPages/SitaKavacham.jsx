...
function SitaKavacham(){

    const sitaRamaStotram = [
        {
            kannada: `ಅಗಸ್ತಿರುವಾಚ |
...
`
        ...
        {
            english: `Agastiruvaacha:
            ya sitaavanisambhavaa atha mithilaapaalena samvardhita
            padmaakshaavanibhukSutaa nalagataa ya maatuluNgodbhavaa
            ya ratne layamaagataa jalanidhau ya vedapaaram gataa
            lankaa sa mrgalocanaa shashimukhii maam paatu raamapriyaa || 1 ||
            
            Mantra:
            asya srii siitaakavacamantrasya agastirRisiH srii siitaa devataa anuSTup chandaha raameti bijam janakajeti shaktiH avanijeti kiilakam padmaakshasutetyastram maatuluNgiiti kavacam muulakaasuraghaaTinIti mantraH srii siitaaraamacandrapriityarthaM sakalakaamanaa siddhyarthaM ca jape viniyogaH |
            
            Atha KaranyaasaH:
            om hraaM siitaayai a"nguSTaabhyaaM namaH |
            om hriiM ramaayai tarjaniiBhyaM namaH |
            om hruuM janakajaayai madhyamaabhyaaM namaH |
            om hraiM avanijaayai anaamikaaBhyaam namaH |
            om hrauM padmaakshasutaayai kaniSThikaaBhyaM namaH |
            om hraH maatuluNgyai karatalakaraprSThaabhyaaM namaH |
            
            Atha a"NganyaasaH:
            om hraaM siitaayai hR^idayaaya namaH |
            om hriiM ramaayai shirase svaahaa |
            om hruuM janakajaayai shikhaayai vaSaT |
            om hraiM avanijaayai kavacaaya hum |
            om hrauM padmaakshasutaayai netratrayaaya vaushaT |
            om hraH maatuluNgyai astraya phaT |
            bhurbhuvassuvaro.iti digbandhaH |
            
            Atha DhyanaM:
            siitaam kamalapatraakshiiM vidyutpunjasamaprabhaam
            dvibhujaam sukumaaraaNgiM piitakauSeyavaasiniim || 1 ||
            
            siMhaasane raamacandravaamabhaagasthitaam varaam
            naanaalankaarasamyuktaaM kuNDaladvayadhaariNiim || 2 ||
            
            cuuDaa"ka~NkaNakeyuuraraSanaanuurpuraMvitaaM
            siMta ra^vicandraabhyaaM niTile tilakena ca || 3 ||
            
            nuururaabharaNe naapi ghraaNe"tishobhitaam shubhaam
            haridraaM kajjalam divyaM ku~NkumaM kusumaani ca || 4 ||
            
            bibhratiM surabhidravyaM sugandhasnehamuttamam
            smitaanaanaM gauravarnaaM mandaarakuSumaM kare || 5 ||
            
            bibhrati mapare haste maatuluNga manuttamam
            ramyahaasaaM ca bimboshhThiM candraavaahanalocanaaM || 6 ||
            
            kalaanaathasamaanaasyaaM kalakanThamanoramaaM
            maatuluNgo.dbhavaaM deviM padmaakSaduhitaM shubhaam || 7 ||
            
            maithiliM raamadayitaM daasibhiH pariviijitaaM
            evaM dhyaatvaa janakajaaM hemakumbhapayodharaaM || 8 ||
            
            Atha Kavacam:
            sriisiitaa puurva taH paatu dakSiNe.avatu jaanakii |
            pratiicyaam paatu vaidehii paatuudiicyaam ca maithilii || 9 ||
            
            adhaH paatu maatuluNgiuurdhvaaM padmaakSajaavatu |
            madhye.avanisutaa paatu sarvataH paatu maM ramaa || 10 ||
            
            smitaana naana shiraH paatu paatu bhaalaM nr^paatmaja |
            padmaa.vatu bhrvor madhye mrgaakSii nayaneavatu || 11 ||
            
            kapoLe karNamuuLe ca paatu shriiraamavallabhaa |
            naasaagram saattviki paatu paatu vaktraM tu raajasii || 12 ||
            
            taamasii paatu madvaaniiM paatu jiHvaaM pativrat aa |
            dantaaM paatu mahaamaayaa cibukaM kanakaprabhaa || 13 ||
            
            paatu kaNThaM saumyaruu paa skandhau paatu suraar citaa |
            bhujau paatu varaaruhaa karau ka~NkaNamanditaa || 14 ||
            
            nakhaan raktanakhaa paatu kukshau paatu laghuudaraa |
            vakshaH paatu raamapatnii paarshve raavaNamohinii || 15 ||
            
            pruSThadeshe vahniguptaa avatu maM sarvadeva hi |
            divyaprad paatu naabhiM kaTiM raakSasamohinii || 16 ||
            
            guhyaM paatu ratnaguptaa li~NgaM paatu haripriyaa |
            uuruu rakSatu rambhuurjaa nunii priyabhaaSiNii || 17 ||
            
            jaNghau paatu sadaa subhruur gulphau caamaraviijitaa |
            paadau lavasutaa paatu paatvaNgaa ni kutaitkaa || 18 ||
            
            paadaa~NguliH sadaa paatu mama nuupuraniHsvanaa |
            romaanyavatu me nityaM piitakauSeyavaasinii || 19 ||
            
            raatrau paatu kaalaruupaa dine daanaikatatparaa |
            sarvakaalesu ma paatu muulakaa suraghaa tinii || 20 ||
            
            evaM sutiikSNa siitaayaH kavacaM te maye'ritam |
            idaM praataH samutthaaya snaatvaa nityaM pathe t punaH || 21 ||
