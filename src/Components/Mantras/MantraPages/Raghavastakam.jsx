...
function Raghavastakam(){
    const raghavastakam = [
        {
            kannada: `ರಾಘವಂ ಕರುಣಾಕರಂ ಮುನಿ-ಸೇವಿತಂ ಸುರ-ವನ್ದಿತಂ
        ...
        {
            english: `Raghavam Karunakaram Munisevitham Suravandhitham |
